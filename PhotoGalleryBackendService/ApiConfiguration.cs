...
using System;
using PhotoGalleryBackendService.App_Start;
using PhotoGalleryBackendService.Utilities;
using PhotoGalleryBackendService.Configuration;
using PhotoGalleryBackendService.Services;
using PhotoGalleryBackendService.Authentication;
using PhotoGalleryBackendService.Filters;

namespace PhotoGalleryBackendService
{
    public class ApiConfiguration
    {
        public static void Install(HttpConfiguration config, IAppBuilder app)
        {
            ...
            config
                .EnableSwagger(c => c.SingleApiVersion("v1", "PhotoGalleryBackendService"))
                .EnableSwaggerUi();
